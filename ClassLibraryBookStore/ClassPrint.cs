...
namespace ClassLibraryBookStore
{
   public  class ClassPrint
   {
        ...
        #region Constructor
        public ClassPrint(string namaFile, Font jenisFont, float marginKiri, float marginKanan, float marginAtas, float marginBawah)
        {
        ...
        public void CetakPrinter(string pTipe)
        {
