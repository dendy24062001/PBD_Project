...
{
    public partial class FormChangeCustomers : Form
    {
        private List<Customers> listOfCustomers=new List<Customers>();

        public FormChangeCustomers()
        {
            InitializeComponent();
        }
        ...
        private void buttonChange_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Customers.UbahData(c);

                MessageBox.Show("Data Customers berhasil diubah", "Info");
            }
            catch (Exception ex)
            {
        ...
        private void FormChangeCustomers_Load(object sender, EventArgs e)
        {
        ...
        private void textBoxId_TextChanged(object sender, EventArgs e)
        {
            if (textBoxId.Text.Length == textBoxId.MaxLength)
            {
                ...
                {
                    MessageBox.Show("Kode Customers tidak ditemukan", "Kesalahan");
                    textBoxNama.Text = "";
                    textBoxAlamat.Text = "";
                    textBoxNama.Text = "";
                    textBoxTelepon.Text = "";
