...
{
    public partial class FormDeleteOfSupplier : Form
    {
        private List<Supplier> listOfSupplier = new List<Supplier>();

        public FormDeleteOfSupplier()
        {
            InitializeComponent();
        }
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            if (konfirmasi == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                if (hasilTambah == "1")
                {
                    MessageBox.Show("Supplier berhasil dihapus.", "Informasi");
                }
                else
                {
        ...
        private void FormDeleteOfSupplier_Load(object sender, EventArgs e)
        {
